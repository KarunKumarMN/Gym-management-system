...
from emp_details import Employee
...
class GymManagement:
    def __init__(self, root):
        ...
        btnimg4.place(x=980, y=350, width=250, height=200)

        lblimg4 = Label(lblimg, text="Developer",
                        bd=4, bg="black", relief=RIDGE, fg="white", font=("times new roman", 18, "bold"))
        lblimg4.place(x=980, y=550, width=250, height=35)
        ...
        btnimg5 = Button(lblimg, image=self.photoimg5,
                         bd=4, relief=RIDGE, command=self.emp)
        btnimg5.place(x=670, y=350, width=250, height=200)

        lblimg5 = Label(lblimg, text="Employee detail",
                        bd=4, bg="black", relief=RIDGE, fg="white", font=("times new roman", 18, "bold"))
        lblimg5.place(x=670, y=550, width=250, height=35)
        ...
        buttonexit = Button(lblimg, text="Exit", bd=4,
                            relief=RIDGE, bg='black', fg='white', command=self.nexit)
        buttonexit.place(x=1152, y=600)
